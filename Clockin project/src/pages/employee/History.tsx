...
import { recordsForEmployee, weeklyMinutes } from '../../data/attendance';
import { formatClockHours, formatDifference, formatHm, prettyDate } from '../../utils/time';
...
export function EmployeeHistory() {
  ...
  const records = recordsForEmployee(currentUser.id).slice(0, Number(range));
  const week = weeklyMinutes(currentUser.id);
