    ...
    <div className="mx-auto max-w-3xl space-y-5">
      ...
      <Panel title="Company details">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Field label="Email domain" htmlFor="co-domain">
            <Input id="co-domain" value={form.domain} onChange={(e) => set('domain', e.target.value)} />
          </Field>
          <Field label="Timezone" htmlFor="co-tz" className="sm:col-span-2">
        ...
        <div className="space-y-1">
          <Toggle
            ...
            onChange={(v) => {
              ...
              if (v) toast.error('Required working hours stay under HR control in Cadence');
            }}
